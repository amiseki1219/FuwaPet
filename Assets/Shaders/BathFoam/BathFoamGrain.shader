// 泡粒シェーダー（本番 / Phase A1）
//
// Assets/Shaders/BathFoamPrototype/BathFoamGrainProto.shader の検証済みコードをそのまま複製し、
// Shader 名だけ本番用に変更したもの。ZTest / Blend / 左右反転フラグの扱いは変えていない。
//
// 【役割】
