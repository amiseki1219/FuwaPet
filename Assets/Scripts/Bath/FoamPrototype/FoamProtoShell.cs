...
namespace Yurufu.FoamPrototype
{
    ...
    public class FoamProtoShell
    {
        ...
        public static FoamProtoShell Create(SkinnedMeshRenderer src, Material foamMaterial)
        {
            ...
            return new FoamProtoShell { Renderer = shell, Source = src };
        }

        /// <summary>マスクとパラメータを Renderer ごとに渡す。マテリアル資産は書き換えない。</summary>
        public void Apply(RenderTexture mask, FoamProtoConfig cfg)
        {
