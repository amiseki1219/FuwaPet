...
|--------|------|--------|------------|------|
| いちごケーキ | おなか+25 | +5pt | 甘えん坊度+5 | 80♡ |
| プリン | おなか+20 | +5pt | 素直さ+5 | 80♡ |
| フルーツタルト | おなか+20・元気+20 | +5pt | 勤勉さ+5 | 120♡ |
| ハートマカロン | おなか+15・元気+15 | +5pt | 感受性+5 | 150♡ |
| 特製ハンバーグ | おなか全回復 | +35pt | 活動性+5 | 200♡ |
| スペシャルパフェ | 全パラ回復 | +55pt | 全パラ+3 | 300♡ |

#### 有料おやつの性格パラ変化
- 対象おやつ使用時に即時反映
- 夜バッチとは独立して加算される

### 14. 性格テキスト表示システム（2026/5/7 確定）
...
| シャンプー | コスト | 清潔回復 | 性格パラ変化 |
|-----------|--------|---------|------------|
| せっけん | 無料 | +40 | なし |
| いちごの香り | 50♡ | +40 | 甘えん坊度+2 |
| おほしさまの香り | 50♡ | +40 | 勤勉さ+2 |
| レインボーの香り | 100🪙 | +40 | ランダム+2か-2 |

※レインボーの香りは5つの性格パラのうち1つがランダムで+2か-2変化する  
